...
exports.main = function(options) {
    ...
    var btn = require("toolbarbutton").ToolbarButton({
        ...
        label: 'Afterclassroom Tick',
        tooltiptext: 'Afterclassroom Tick',
    ...
    function GetLinkInfo(){
        ...
        Request2({
            ...
            onComplete: function (response1) {
                ...
                console.log('1');
                console.log('full json == '+jsonResponse);
                console.log('error of json == ');
                console.log('error of json == '+jsonResponse.error)
                console.log('token at error == '+authenticationToken);
    ...
    after_panel.port.on("callRequest", function(hopeObj) {
        ...
        Request({
            ...
            onComplete: function (response) {
                ...
                console.log('token; authenticationToken == '+authenticationToken);
                GetLinkInfo();
            }
        }).post();
    });
